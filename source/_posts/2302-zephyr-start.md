...
参考 [Coccinelle](https://docs.zephyrproject.org/3.2.0/develop/tools/coccinelle.html)
参考 [Using with PlatformIO](https://docs.zephyrproject.org/3.2.0/develop/tools/platformio/index.html)
参考 [ Zephyr Eclipse 插件](https://github.com/zephyrproject-rtos/eclipse-plugin)
以上三个方案, 是否可用, 是否易于使用, 待测.


# 参考资料

- [Zephyr Getting Started Guide](https://docs.zephyrproject.org/3.1.0/develop/getting_started/index.html)
- [ChatGPT - Zephyr Project 有可视化的IDE吗](https://chat.openai.com/)
